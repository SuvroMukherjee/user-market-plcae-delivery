...
//   useEffect(() => {
//     if (filterSearchProductArray) {
//       getProductsBrandHandler(filterSearchProductArray);
//       if (catId !== "all") {
//         getOtherFilterHandler(filterSearchProductArray);
//       }
//     }
//   }, [filterSearchProductArray, catId]);
  ...
  const getProductsBrandHandler = (products) => {
    ...
    setFilterBrandArray(Array.from(brandMap.values()));
  };
                    ...
                    <span
                      style={{
                        ...
                        border:
                          ...
                          color?.name?.toLocaleLowerCase() == "off white" ||
                          color?.name?.toLocaleLowerCase() == "beige"
                            ? "0.5px solid #322C2B"
                            : "none",
