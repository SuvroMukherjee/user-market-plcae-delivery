...
const CancellationRefundPolicy = () => {
  return (
    <div className="">
      ...
      <p>Order Cancellation and Return Policy</p>
      <p>Cancellation Policy</p>
      <p>
        The customer can choose to cancel an order any time before it's
        dispatched. The order cannot be cancelled once it&rsquo;s out for
        delivery. However, the customer may choose to reject it at the doorstep.
      </p>
      <p>
        The time window for cancellation varies based on different categories
        and the order cannot be cancelled once the specified time has passed.
      </p>
      <p>
      ...
      <p>
        Zoofi reserves the right to accept the cancellation of any order. Zoofi
        also reserves the right to waive off or modify the time window or
      ...
      <p>
        ...
        page for any exceptions to this returns policy and the table below
      </p>
      <p>
        ...
        <tbody>
          ...
          <tr>
            <td bgcolor="#ffffff" width="330">
              <p>Furniture</p>
              <p>
                Home: Pet Supplies &amp; Rest of Home. (Except Home
                d&eacute;cor, Furnishing, Home Improvement Tools, Household
                Items)
              </p>
            </td>
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                ...
                <br />
                <br /> For products requiring installation, returns shall be
                eligible only
                <br /> when such products are installed by the brand&amp;#39;s
                authorized
                <br /> personnel.
                <br />
                <br /> In order to help you resolve issues with your product, we
                may
                <br /> troubleshoot your product either through online tools,
                over the
                <br /> phone, and/or through an in-person technical visit.
              </p>
              <p>
                <br /> If a defect is determined within the Returns Window, a
                <br /> refund/replacement of the same product will be provided
                at no
                <br /> additional cost. If no defect is confirmed or the issue
                is not
                <br /> diagnosed within 7 days of delivery or Installation
                wherever
                <br /> applicable, you will be directed to a brand service
                centre to
                <br /> resolve any subsequent issues.
              </p>
              <p>
                <br /> In any case, only one replacement shall be provided
              </p>
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff" width="330">
              <p>
                ...
                Kid&rsquo;s (Capri, Shorts &amp; Tops), Men&rsquo;s (Ethnic
                Wear, Shirt, Formals, Jeans, Clothing Accessory), Women&rsquo;s
                (Ethnic Wear, Fabric, Blouse, Jean, Skirt, Trousers, Bra), Bags,
                Raincoat, Sunglass, Belt, Frame, Backpack, Suitcase, Luggage,
                etc...
              </p>
              <p>
                Lifestyle: Jewellery, Footwear Accessories, Travel Accessories,
                Watch Accessories, etc..
              </p>
              <p>
                Lifestyle: WinterWear(sweatshirt, jacket, sweater, cardigan,
                kids_thermal, pullover, windcheater, track_suit, thermal,shawl,
                track_top, glove, muffler, scarf, blazer, uniform_sweatshirt,
                uniform_blazer, kids_muffler, kids_mitten, shrug,
                poncho,uniform_sweater, cap, waistcoat, leg_warmer,
          ...
          <tr>
            <td bgcolor="#ffffff" width="330">
              <p>
                Home: Home Improvement Tools, Household Items, Home
                d&eacute;cor, Furnishing
              </p>
            </td>
            <td bgcolor="#ffffff" width="237">
              <p>7 days</p>
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                Please keep the product intact, with original accessories, user
                manual and warranty cards in the original packaging at the time
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                ...
                damaged/defective condition or different from the ordered item,
                we will provide a free replacement.
              </p>
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff" width="330">
              ...
              <p>
                All Small Home Appliances (Except Chimney, Water Purifier, Fan,
                Geyser)
              </p>
            ...
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                ...
                within 7 days of delivery, you will be directed to a brand
                service center to resolve any subsequent issues.
              </p>
          ...
          <tr>
            <td bgcolor="#ffffff" width="330">
              <p>
                Mobile &ndash; Apple, Google, Motorola, Infinix, Redmi, MI,
                Vivo, POCO, Realme, Samsung phones
              </p>
              <p>
                Electronics - Acer, AMKETTE, Apple/Beats, Bose, Brother, Canon,
                Compaq, CREATIVE, DELL, DIZO, Epson, Google, GoPro, GOVO, HP,
                INFINITY, JBL, Lenovo, LG, Lifelong, Mi, MOTOROLA, Nothing,
                OnePlus, OPPO, Panasonic, PHILIPS, Realme, REDMI, SAMSUNG,
                Sansui, Seagate, Sonos, SONY, Thomson, Total, Xiaomi products
                (Tablets, Laptops, Smart Watches, Headphones, Speakers)
              </p>
              <p>
                Large &ndash;Vu, LG, Godrej, Haier, IFB, Hindware , Glen, Faber,
            ...
            <td bgcolor="#ffffff" width="237">
              <p>7 Days Service Center Replacement/Repair only</p>
              <p>
              ...
              <p>
                Please note that Zoofi is an online marketplace and the final
                decision on replacement of defective device rests with the
                seller/brand
              </p>
              <p>
                For Samsung, in case of DOA approved by brand, share the
                certificate of approval to the Zoofi customer support team to
              ...
              <p>
                For any other issues with the product, you may contact Zoofi -
                Zoofi&rsquo;s 24&times;7 Customer Care
              </p>
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff" width="330">
              <p>
                ...
                Haier, IFB, Hindware, Glen, Faber, AGARO, Voltas, BOSCH, Pureit,
                PHILIPS, HAVELLS, Elica, BAJAJ, Kenstar, Eureka Forbes Aquasure
                from Aquaguard, Aquaguard, LIVPURE, EUREKA FORBES, Crompton,
                Hindware Snowcrest, Hindware Calisto, Eurodomo, Symphony,
                Hindware Atlantic, ONIDA, CANDY, Llyod, Voltas Beko, realme,
                Daikin, CARRIER, Mi, Midea, Whirlpool, Blue Star, Panasonic,
                Morphy Richards, iFFALCON, Hisense, TCL,TOSHIBA, Hitachi,
                Rockwell, KENT )
              </p>
              <p>
            ...
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                ...
                only when such products are installed by the brand's authorized
                personnel.
              </p>
              <p>
                In order to help you resolve issues with your product, we may
              ...
              <p>
                ...
                replacement of the same model will be provided at no additional
                cost. If no defect is confirmed or the issue is not diagnosed
                within 10 days of delivery or Installation wherever applicable,
                you will be directed to a brand service centre to resolve any
                subsequent issues.
              </p>
              <p>In any case, only one replacement shall be provided.</p>
            </td>
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                ...
                through the Platform, subject to product validations at the time
                of pick-up and fraud prevention mechanisms.
              </p>
              <p>
                This policy shall be applicable only if the product was bought
                when this policy was applicable to the product. If not, the
                policy provided&nbsp;here&nbsp;shall apply to the order. It is
                clarified that a customer may only be able to seek a one-time
                replacement under this Policy, subject to the other terms
                provided herein.
              </p>
              <p>
                Exceptions to this policy: Following claims will be covered
                under the policy provided&nbsp;here&nbsp;and through
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" width="237">
              <p>
                ...
                their nature or other reasons. For all products, the policy on
                the product page shall prevail.
              </p>
              <p>
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" width="237">
              ...
              <p>
                ...
                replacement of the same model will be provided at no additional
                cost. If no defect is confirmed or the issue is not diagnosed
                within 7 days of delivery, you will be directed to the warranty
      ...
      <p>
        Part 2 - Returns Pick-Up and Processing In case of returns where you
        would like item(s) to be picked up from a different address, the address
        can only be changed if pick-up service is available at the new address
      ...
      <table width="601" cellspacing="0" cellpadding="8">
        <thead>
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" width="483">
              <p>
                The product&rsquo;s original packaging/ box should be undamaged.
              </p>
            </td>
          </tr>
        </thead>
      ...
      <ol>
        ...
        <li>
          <p>
            ...
            amount equivalent to the price of the accessory, at the
            seller&rsquo;s discretion.
          </p>
        </li>
        <li>
          <p>
            ...
            applicable.&nbsp;Click here&nbsp;to know more about Open Box
            Delivery
          </p>
        </li>
        <li>
          <p>
            For products where installation is provided by Zoofi's service
            partners, do not open the product packaging by yourself. Zoofi
            authorised personnel shall help in unboxing and installation of the
            product.
          </p>
        </li>
        <li>
      ...
      <p>
        Zoofi holds the right to restrict the number of returns created per
        order unit, post the evaluation of the product/order defect is
        undertaken by Zoofi&rsquo;s authorized representative.
      </p>
    </div>
  );
};
